...
export function ShareButtons({
  ...
  description = "Compliance-first intelligent digital asset powered by advanced AI",
  className = ""
}: ShareButtonsProps) {
  ...
  return (
    <div className={`flex flex-wrap items-center gap-3 ${className}`}>
      ...
      <button
        ...
        className="group p-2 rounded-lg bg-slate-800/50 hover:bg-slate-700 border border-slate-700 hover:border-cyan-500/50 transition-all"
